javascript:(function(){if (
  ...
  window.location.hostname.includes('infinityforever.vercel.app')
  ...
  return [
    {
      ...
      changes: [
        ...
        { text: "Games Update", desc: "Added suggestions for y'all to suggest me games :D" },
...
} else {alert('This bookmarklet only works on google.com, (or infinityforever.vercel.app if you want to use that) this is for data saving purposes and for keeping the data in 1 place.');}})();